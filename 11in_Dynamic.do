...
* 加载第一个数据集
use "11in_11.dta", clear

* 逐个合并剩余的数据集
merge 1:m id using "11in_14.dta"
drop _merge
merge 1:m id using "11in_18.dta"
drop _merge

* 保存合并后的数据集
*确认一下Obs是不是你对应入组年份的n就可以保存了
save "11in_Merge.dta", replace
...
drop if g21_11 == 88|g21_11 == .|g21_11 == 99
drop if g22_11 == 9|g21_11 == .|g22_11 == 8
drop if cmm_11 == .
drop if g21_11 > 32
...
* livetime 
gen livetime = .
replace livetime = yearin_14 - yearin_11 if mmse_bi_11 == 0 & mmse_bi_14 == 1
replace livetime = yearin_14 - yearin_11 if mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == .
replace livetime = yearin_18 - yearin_11 if mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == 1
replace livetime = yearin_18 - yearin_11 if mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == 0
tab livetime
