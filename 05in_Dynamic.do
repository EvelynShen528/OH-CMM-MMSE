...
gen ends_with_05 = substr(id_str, length(id_str)-1, 2) == "05"
tab ends_with_05
keep if ends_with_05 == 1
drop id_str
drop ends_with_05 
...
* 加载第一个数据集
use "05in_05.dta", clear

* 逐个合并剩余的数据集
merge 1:m id using "05in_08.dta"
drop _merge
merge 1:m id using "05in_11.dta"
drop _merge
merge 1:m id using "05in_14.dta"
drop _merge
merge 1:m id using "05in_18.dta"
drop _merge
...
drop if g21_05 == 99|g21_05 == .
drop if g22_05 == 9|g21_05 == .
drop if cmm_05 == .
drop if g21_05 > 32
...
* Status （00入组那就是从02开始）
gen status = .
replace status = 1 if mmse_bi_08 == 1 | mmse_bi_11 == 1 | mmse_bi_14 == 1 | mmse_bi_18 == 1
replace status = 0 if status == .
tabulate status
* livetime 
gen livetime = .
replace livetime = yearin_08 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 1
replace livetime = yearin_08 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == .
replace livetime = yearin_11 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 1
replace livetime = yearin_11 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == .
replace livetime = yearin_14 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 1
replace livetime = yearin_14 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == .
replace livetime = yearin_18 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == 1
replace livetime = yearin_18 - yearin_05 if mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == 0
tab livetime
