...
gen ends_with_02 = substr(id_str, length(id_str)-1, 2) == "02"
tab ends_with_02
keep if ends_with_02 == 1
drop id_str
drop ends_with_02 
...
* 加载第一个数据集
use "02in_02.dta", clear

* 逐个合并剩余的数据集
merge 1:m id using "02in_05.dta"
drop _merge
merge 1:m id using "02in_08.dta"
drop _merge
merge 1:m id using "02in_11.dta"
drop _merge
merge 1:m id using "02in_14.dta"
drop _merge
merge 1:m id using "02in_18.dta"
drop _merge

* 保存合并后的数据集
*确认一下Obs是不是你对应入组年份的n就可以保存了
save "02in_Merge.dta", replace
...
drop if g21_02 == 99|g21_02 == .
drop if g22_02 == 9|g21_02 == .
drop if cmm_02 == .
drop if g21_02 > 32
...
* Status （00入组那就是从02开始）
gen status = .
replace status = 1 if mmse_bi_05 == 1 | mmse_bi_08 == 1 | mmse_bi_11 == 1 | mmse_bi_14 == 1 | mmse_bi_18 == 1
replace status = 0 if status == .
tabulate status
* livetime 
gen livetime = .
replace livetime = yearin_05 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 1
replace livetime = yearin_05 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == .
replace livetime = yearin_08 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 1
replace livetime = yearin_08 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == .
replace livetime = yearin_11 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 1
replace livetime = yearin_11 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == .
replace livetime = yearin_14 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 1
replace livetime = yearin_14 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == .
replace livetime = yearin_18 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == 1
replace livetime = yearin_18 - yearin_02 if mmse_bi_02 == 0 & mmse_bi_05 == 0 & mmse_bi_08 == 0 & mmse_bi_11 == 0 & mmse_bi_14 == 0 & mmse_bi_18 == 0
tab livetime
